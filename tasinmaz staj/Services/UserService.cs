...
public class UserService : IUserService
{
    ...
    public async Task<object> GetUsersAsync(UserFilterDto filter)
    {
        ...
        var users = await query
            ...
            .Select(u => new { u.Id, u.Email, u.Role }) // Şifre hash'lerini listeye dahil etmiyoruz
            .ToListAsync();
    ...
    {
        // Şifre Hashleme işlemi (Kendi yazdığın PasswordHelper'a göre uyarla)
    ...
    public async Task<bool> UpdateUserAsync(int id, UserUpdateDto dto)
    {
        ...
        {
            // Yeni şifre girildiyse onu da hashleyip güncelle
    ...
    public async Task<bool> DeleteUserAsync(int id)
    {
        ...
        // REQ-5: Kullanıcı silinince ona ait taşınmazların da silinmesi (Cascade Delete)[cite: 1]
