...
{
    /// <inheritdoc />
    public partial class AddIlPlakaKodu : Migration
    {
        // Standart Türkiye il plaka kodu listesi (1-81).
        private static readonly Dictionary<string, int> PlakaKodlari = new Dictionary<string, int>
        {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Mevcut kayıtları isim eşleştirmesiyle doldur. Ad sütununda
            // olası baş/son boşlukları da tolere etmek için TRIM kullanılır.
            foreach (var kvp in PlakaKodlari)
            {
                migrationBuilder.Sql(
                    $"UPDATE \"Iller\" SET \"PlakaKodu\" = {kvp.Value} " +
                    $"WHERE TRIM(\"Ad\") = '{kvp.Key.Replace("'", "''")}';");
            }
        }
